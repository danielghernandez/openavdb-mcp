...
export function registerPrompts(server) {
    ...
    server.prompt('analyze-airport', 'Comprehensive analysis of an airport including facilities, services, and based aircraft.', {
...
Format the response with clear sections and actionable insights.`
    ...
    // Compare FBOs prompt
    server.prompt('compare-fbos', 'Compare FBOs at an airport or across multiple airports.', {
...
Provide a comparison table and recommendation for each airport.`
    ...
    server.prompt('find-aircraft', 'Search for specific aircraft by type, manufacturer, or location.', {
...
4. Summary statistics (total count, breakdown by model)`
    ...
    server.prompt('research-charter', 'Research charter companies in a specific region.', {
...
Provide a market summary suitable for someone looking to charter flights in this region.`
    ...
    server.prompt('find-flight-schools', 'Find flight training schools near an airport or in a state.', {
...
Provide recommendations for someone looking to start flight training.`
    ...
    server.prompt('market-analysis', 'Aviation market analysis for a specific airport or region.', {
...
Conclude with key market insights and opportunities.`
    ...
    server.prompt('create-fleet-watchlist', 'Create a watchlist to track specific aircraft.', {
