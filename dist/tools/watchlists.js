...
export function registerWatchlistTools(server) {
    // List watchlists
    server.tool('list_watchlists', 'List all aircraft watchlists for the authenticated user.', {}, async () => {
        try {
    ...
    server.tool('get_watchlist', 'Get detailed information about a specific watchlist.', {
    ...
    server.tool('get_watchlist_aircraft', 'Get all aircraft in a specific watchlist with their current details.', {
        id: z.string().describe('Watchlist ID'),
    }, async (params) => {
        try {
    ...
    // Create watchlist
    server.tool('create_watchlist', 'Create a new aircraft watchlist.', {
    ...
    server.tool('add_aircraft_to_watchlist', 'Add an aircraft to a watchlist by its registration number.', {
