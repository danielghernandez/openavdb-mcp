...
export function registerFlightSchoolTools(server) {
    // Search flight schools
    server.tool('search_flight_schools', 'Search for flight training schools by state or airport.', {
    ...
    server.tool('get_flight_school', 'Get detailed information about a specific flight school.', {
...
//# sourceMappingURL=flight-schools.js.map