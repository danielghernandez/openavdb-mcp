...
export function registerActivityTools(server) {
    ...
    server.tool('search_flight_activity', 'Search for flight activity records by airport, operation type, or date range.', {
    ...
    server.tool('get_activity_stats', 'Get aggregated flight activity statistics for an airport.', {
