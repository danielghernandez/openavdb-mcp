...
export function registerFleetTools(server) {
    // Search fleet
    server.tool('search_fleet', 'Search for based aircraft at airports by type or owner category.', {
    ...
    server.tool('get_fleet_stats', 'Get aggregated fleet statistics for an airport or aircraft type.', {
