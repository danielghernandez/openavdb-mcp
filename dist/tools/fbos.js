...
export function registerFBOTools(server) {
    // Search FBOs
    server.tool('search_fbos', 'Search for Fixed Base Operators (FBOs) by state, airport, brand, or tower status. FBOs are service providers at airports.', {
    ...
    // Get FBO details
    server.tool('get_fbo', 'Get detailed information about a specific FBO by its ID.', {
    ...
    // Get fuel prices
    server.tool('get_fuel_prices', 'Search for aviation fuel prices across FBOs. Filter by airport, state, city, FBO chain, fuel type, and service type. Sort by price or last updated.', {
