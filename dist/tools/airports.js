...
export function registerAirportTools(server) {
    // Search airports
    server.tool('search_airports', 'Search for US airports by state, city, runway length, or control tower status. Returns a list of airports matching the criteria.', {
