...
export function registerFractionalTools(server: McpServer): void {
  // Search fractional providers
  server.tool(
    'search_fractional_providers',
    'Search for fractional aircraft ownership providers (e.g., NetJets, Flexjet).',
    {
  ...
  server.tool(
    'get_fractional_provider',
    'Get detailed information about a specific fractional ownership provider.',
    {
