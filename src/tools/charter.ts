...
export function registerCharterTools(server: McpServer): void {
  // Search charter companies
  server.tool(
    'search_charter_companies',
    'Search for Part 135 charter companies by certificate type or state.',
    {
  ...
  server.tool(
    'get_charter_company',
    'Get detailed information about a specific charter company.',
    {
  ...
  server.tool(
    'search_charter_brokers',
    'Search for charter brokers who arrange private flights.',
    {
      limit: z.number().optional().default(20).describe('Maximum results (max 100)'),
      offset: z.number().optional().default(0).describe('Pagination offset'),
    },
  ...
  server.tool(
    'get_charter_broker',
    'Get detailed information about a specific charter broker.',
    {
