...
export function registerHangarTools(server: McpServer): void {
  // Search hangars
  server.tool(
    'search_hangars',
    'Search for aircraft hangars by airport, size, or availability.',
    {
  ...
  server.tool(
    'get_hangar',
    'Get detailed information about a specific hangar.',
    {
